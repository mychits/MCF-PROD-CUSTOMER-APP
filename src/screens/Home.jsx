        ...
        Linking.canOpenURL(`tel:${phoneNumber}`)
            ...
            .catch((error) => {
                ...
                Toast.show({
                    type: 'error',
                    text1: 'Error',
                    text2: 'An error occurred while checking phone call availability for customer support.',
                    position: 'bottom',
                    visibilityTime: 4000,
                });
            });
            ...
            <ScrollView style={styles.mainScrollView} contentContainerStyle={styles.contentContainer}>
                ...
                <View style={styles.servicesSection}>
                    ...
                    <View style={styles.benefitsSection}>
                        ...
                        {/* Moved "Advantages of MyChits" section here */}
                    ...
                    {/* App Info Footer with updated styling */}
                    <LinearGradient
...
const styles = StyleSheet.create({
    ...
    headerTitle: { color: '#fff', fontSize: 20, fontWeight: 'bold', marginLeft: 22, marginTop: 10 },
    ...
    servicesTitle: {
        position: 'absolute', top: -20, alignSelf: 'center', backgroundColor: '#B3E5FC', width: 230, height: 40, borderRadius: 11, textAlign: 'center', textAlignVertical: 'center', color: '#053B90', fontWeight: '900', fontSize: 20, lineHeight: 22, textTransform: 'capitalize', borderWidth: 1,
        borderColor: '#053B90',
    },
