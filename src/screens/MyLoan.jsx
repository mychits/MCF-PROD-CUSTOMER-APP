      ...
      <View style={confirmStyles.overlay}>
        ...
        >
          ...
          <View style={confirmStyles.summaryCard}>
            <View style={confirmStyles.summaryRow}>
              <View style={confirmStyles.summaryIcon}>
                <Ionicons name="person-outline" size={15} color={Colors.primaryBlue} />
              </View>
            ...
            <View style={confirmStyles.summaryRow}>
              <View style={confirmStyles.summaryIcon}>
                <Ionicons name="call-outline" size={15} color={Colors.primaryBlue} />
              </View>
              <Text style={confirmStyles.summaryLabel}>Phone</Text>
              <Text style={confirmStyles.summaryValue}>{formData.phoneNumber || "—"}</Text>
            </View>
            <View style={confirmStyles.divider} />
            <View style={confirmStyles.summaryRow}>
              <View style={confirmStyles.summaryIcon}>
            ...
            <View style={confirmStyles.summaryRow}>
              <View style={confirmStyles.summaryIcon}>
                <Ionicons name="flag-outline" size={15} color={Colors.vibrantBlue} />
              </View>
              <Text style={confirmStyles.summaryLabel}>Purpose</Text>
              <Text style={confirmStyles.summaryValue}>{finalPurpose || "—"}</Text>
            </View>
          </View>
          ...
          <View style={confirmStyles.buttonRow}>
            ...
            >
              <Ionicons name="arrow-back-outline" size={16} color={Colors.mediumText} />
              <Text style={confirmStyles.cancelBtnText}>Go Back</Text>
            </TouchableOpacity>

            <TouchableOpacity
              style={[confirmStyles.confirmBtn, isSubmitting && { opacity: 0.75 }]}
              onPress={onConfirm}
              disabled={isSubmitting}
              activeOpacity={0.85}
            >
    ...
    <Modal transparent animationType="none" visible={visible} onRequestClose={onClose}>
      <View style={successStyles.overlay}>
        ...
        >
          ...
          {/* Success Icon */}
          <Animated.View
            style={[successStyles.iconWrap, { transform: [{ scale: pulseAnim }] }]}
          >
          ...
          <View style={successStyles.badgeRow}>
            ...
            <View style={successStyles.badge}>
              <Ionicons name="notifications-outline" size={14} color={Colors.successGreen} />
              <Text style={successStyles.badgeText}>You'll be notified</Text>
            </View>
          </View>

          <TouchableOpacity style={successStyles.doneBtn} onPress={onClose} activeOpacity={0.85}>
...
const MyLoan = ({ route, navigation }) => {
  ...
  const handleWhatsAppPress = () =>
    Linking.openURL(`whatsapp://send?phone=${CONTACT_WHATSAPP}&text=Hello, I would like to apply for a loan.`);
  ...
  const validateAndGetFirstError = () => {
    ...
    } else if (!/^\+?\d{10,13}$/.test(formData.phoneNumber.trim().replace(/\s/g, ""))) {
  ...
  const scrollToField = (fieldName) => {
    const refMap = {
      ...
      otherPurpose: { containerRef: otherPurposeContainerRef, inputRef: otherPurposeRef },
    };
  ...
  // Step 2: Actually submit after confirm
  const handleConfirmedSubmit = async () => {
    ...
    try {
      ...
      if (res.status === 201 || res.status === 200) {
        ...
        setFormData(prev => ({ ...prev, loanAmount: "", loanPurpose: "", otherPurpose: "" }));
        setFieldErrors({});
      }
    } catch (err) {
      Toast.show({
    ...
    <SafeAreaView style={styles.safeArea}>
      ...
      <View style={styles.outerBoxContainer}>
        <View style={styles.fixedTitleContainer}>
          {loanId && (
            <TouchableOpacity
              onPress={() => { setLoanId(null); setCurrentPage(1); }}
                  ...
                  <View style={styles.noLoanContainer}>
                    ...
                    <View style={styles.contactGroup}>
                      ...
                      <View style={styles.contactRow}>
                        <TouchableOpacity onPress={handlePhonePress} style={styles.contactButtonHalf}>
                          <Ionicons name="call-outline" size={20} color={Colors.accentColor} />
                          <Text style={styles.contactButtonTextCall}>Call Us</Text>
                        </TouchableOpacity>
                        <TouchableOpacity onPress={handleWhatsAppPress} style={styles.contactButtonWhatsApp}>
                          <Ionicons name="logo-whatsapp" size={20} color="#25D366" />
                          <Text style={styles.contactButtonTextWhatsApp}>WhatsApp</Text>
                        </TouchableOpacity>
                      </View>
                    </View>
                  </View>
          ...
          <View style={styles.centeredModalContent}>
            ...
            <View style={styles.centeredModalBand}>
              ...
              <View style={styles.centeredModalHeaderRow}>
                ...
                <View style={{ flex: 1 }}>
                  <Text style={styles.centeredModalTitle}>Loan Application</Text>
                  <Text style={styles.centeredModalSubtitle}>Fill in the details below</Text>
                </View>
                <TouchableOpacity onPress={handleCloseModal} style={styles.centeredCloseBtn}>
            ...
            >
              ...
              <View style={styles.centeredFormSection}>
                <View style={styles.formSectionHeader}>
                  ...
                  <Text style={styles.formSectionTitle}>Applicant Information</Text>
                </View>

                <View ref={fullNameContainerRef} collapsable={false} style={styles.fieldWrapper}>
                  <Text style={styles.inputLabel}>
                    Full Name <Text style={styles.requiredStar}>*</Text>
                  </Text>
                  <View style={[styles.inputWrapper, fieldErrors.fullName ? styles.inputWrapperError : null]}>
                    <Ionicons name="person-outline" size={18} color={fieldErrors.fullName ? Colors.errorRed : Colors.mediumText} style={styles.inputIcon} />
                    <TextInput
                      ref={fullNameRef}
                      style={styles.input}
                ...
                <View ref={phoneContainerRef} collapsable={false} style={styles.fieldWrapper}>
                  <Text style={styles.inputLabel}>
                    Phone Number <Text style={styles.requiredStar}>*</Text>
                  </Text>
                  <View style={[styles.inputWrapper, fieldErrors.phoneNumber ? styles.inputWrapperError : null]}>
                    <Ionicons name="call-outline" size={18} color={fieldErrors.phoneNumber ? Colors.errorRed : Colors.mediumText} style={styles.inputIcon} />
                    <TextInput
                      ref={phoneRef}
                      style={styles.input}
                      keyboardType="phone-pad"
                      value={formData.phoneNumber}
                      onChangeText={(txt) => handleFieldChange("phoneNumber", txt)}
              ...
              <View style={styles.centeredFormSection}>
                <View style={styles.formSectionHeader}>
                  <View style={[styles.sectionIconDot, { backgroundColor: Colors.gold }]} />
                  <Text style={styles.formSectionTitle}>Loan Details</Text>
                </View>

                <View ref={amountContainerRef} collapsable={false} style={styles.fieldWrapper}>
                  <Text style={styles.inputLabel}>
                    Required Loan Amount <Text style={styles.requiredStar}>*</Text>
                  </Text>
                  <View style={[styles.inputWrapper, fieldErrors.loanAmount ? styles.inputWrapperError : null]}>
                    <Text style={[styles.currencyPrefix, fieldErrors.loanAmount ? { color: Colors.errorRed } : null]}>₹</Text>
                    <TextInput
                      ref={amountRef}
                      style={[styles.input, { paddingLeft: 4 }]}
                      keyboardType="numeric"
                      value={formData.loanAmount}
                      onChangeText={(txt) => handleFieldChange("loanAmount", txt)}
                      placeholder="0.00"
                      placeholderTextColor="#AAAAAA"
                      returnKeyType="done"
                    />
                ...
                <View ref={purposeContainerRef} collapsable={false} style={styles.fieldWrapper}>
                  <Text style={styles.inputLabel}>
                        ...
                        <TouchableOpacity
                          ...
                          onPress={() => {
                            ...
                            if (option.label !== "Others") {
                              setFieldErrors(prev => ({ ...prev, otherPurpose: "" }));
                            }
                          }}
                          activeOpacity={0.8}
                        >
                          <Ionicons
                            name={option.icon}
                            size={18}
                            color={isSelected ? Colors.primaryBlue : Colors.mediumText}
                          />
                ...
                {formData.loanPurpose === "Others" && (
                  <View ref={otherPurposeContainerRef} collapsable={false} style={styles.fieldWrapper}>
                    <Text style={styles.inputLabel}>
                      Please specify <Text style={styles.requiredStar}>*</Text>
                    </Text>
                    <View style={[styles.inputWrapper, fieldErrors.otherPurpose ? styles.inputWrapperError : null]}>
                      <Ionicons name="create-outline" size={18} color={fieldErrors.otherPurpose ? Colors.errorRed : Colors.mediumText} style={styles.inputIcon} />
                      <TextInput
                        ref={otherPurposeRef}
                        style={styles.input}
                        value={formData.otherPurpose}
                        onChangeText={(txt) => handleFieldChange("otherPurpose", txt)}
              ...
              <View style={styles.centeredCertBox}>
                <Ionicons name="shield-checkmark-outline" size={16} color={Colors.primaryBlue} />
              ...
              >
                <View style={styles.submitButtonInner}>
                  <Text style={styles.submitFormButtonText}>Review & Submit</Text>
...
const styles = StyleSheet.create({
  ...
  contactButtonHalf: { flex: 1, flexDirection: 'row', alignItems: 'center', justifyContent: 'center', borderWidth: 2, borderColor: Colors.accentColor, paddingVertical: 12, paddingHorizontal: 10, borderRadius: 10, gap: 6 },
  contactButtonTextCall: { color: Colors.accentColor, fontSize: 15, fontWeight: '700' },
  contactButtonWhatsApp: { flex: 1, flexDirection: 'row', alignItems: 'center', justifyContent: 'center', borderWidth: 2, borderColor: '#25D366', paddingVertical: 12, paddingHorizontal: 10, borderRadius: 10, gap: 6 },
